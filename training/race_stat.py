...
for inputFile in inputFiles:
    ...
    with open(inputFile, encoding="utf-8", errors='replace') as dataset_file:
        ...
        for r in rows:
            ...
            article = nlp2.spilt_sentence_to_array(article, True)
            question = nlp2.spilt_sentence_to_array(question, True)
            answer = nlp2.spilt_sentence_to_array(answer, True)
            ...
            for dist in distractors:
                dist = nlp2.spilt_sentence_to_array(dist, True)
